<template>
  <div class="bg-white px-3" style="margin: -16px -20px 0px -20px">
    ...
    >
      ...
      <el-table-column label="商品訊息" prop="name" width="200" align="center">
      </el-table-column>

      <el-table-column prop="username" label="商品清單" width="" align="center">
      </el-table-column>

      <el-table-column prop="price" label="訂單金額" width="" align="center">
      </el-table-column>

      <el-table-column prop="" label="收貨訊息" width="" align="center">
      </el-table-column>

      <el-table-column prop="content" label="買家" width="" align="center">
      </el-table-column>

      <el-table-column prop="code" label="交易狀態" width="" align="center">
      </el-table-column>
